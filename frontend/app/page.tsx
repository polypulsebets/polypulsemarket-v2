...
import { MOCK_USDT_ADDRESS, ERC20_ABI, ADMIN_WALLETS } from './constants';
  ...
  return (
    <div className="min-h-screen bg-[#0F172A] text-slate-200 font-sans flex flex-col h-screen overflow-hidden">
      ...
      <div className="flex flex-1 max-w-7xl mx-auto w-full overflow-hidden">
        ...
        {/* --- SIDEBAR --- */}
        <aside className="hidden md:flex flex-col w-56 py-8 border-r border-slate-800 pr-6 shrink-0 h-full overflow-y-auto">
            ...
            <div className="mt-8 pt-8 border-t border-slate-800 px-4 space-y-3">
                <button 
                    ...
                    className="flex items-center gap-2 text-slate-300 text-xs hover:text-white w-full p-2 bg-slate-800 rounded-lg border border-slate-700 font-bold justify-center transition-all"
                >
                    🔄 Get Funds (Swap)
                </button>
        ...
        <main className="flex-1 flex flex-col h-full overflow-hidden">
             <div className="flex flex-col h-full">
                ...
                <div className="p-6 md:p-8 pb-0 shrink-0">
                    <div className="relative mb-8 p-8 rounded-3xl overflow-hidden border border-slate-800 bg-slate-900 relative group shadow-2xl">
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row justify-between items-end gap-6">
                            <div className="flex items-center gap-3 mb-2"><span className="text-4xl animate-bounce">🔥</span><h2 className="text-4xl font-extrabold text-white mb-2 tracking-tight">{activeCategory === 'All' ? 'All Markets' : `${activeCategory} Markets`}</h2></div>
                            <div className="flex gap-6 bg-slate-950/50 p-4 rounded-2xl border border-slate-800/50 backdrop-blur-sm shadow-inner">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 mb-2">
                        ...
                        <div className="relative min-w-[180px]">
                            ...
                            >
                                ...
                                <option value="VOLUME">💰 Highest Vol</option>
                ...
                <div className="flex-1 overflow-y-auto p-6 md:p-8 pt-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {paginatedMarkets.length === 0 ? (
                            <div className="col-span-3 text-center py-20 text-slate-500 border border-dashed border-slate-800 rounded-2xl">
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 animate-in fade-in">
            <div className="bg-slate-900 border border-slate-800 p-8 rounded-2xl max-w-sm w-full shadow-2xl relative text-center">
                ...
                <div className="space-y-3">
                    <a href="https://ramp.network/buy" target="_blank" className="block w-full py-3 bg-slate-800 hover:bg-slate-700 text-white font-bold rounded-xl border border-slate-700 transition-all">Ramp Network</a>
                    <a href="https://www.moonpay.com/buy" target="_blank" className="block w-full py-3 bg-slate-800 hover:bg-slate-700 text-white font-bold rounded-xl border border-slate-700 transition-all">MoonPay</a>
                </div>
